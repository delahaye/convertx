 ...
 */
class Inserthook implements Conversion
{
    ...
    {
        $return = System::importStatic($GLOBALS['TL_HOOKS']['convertx']['field'][$objConverterfields->hookInsert][0])->$GLOBALS['TL_HOOKS']['convertx']['field'][$objConverterfields->hookInsert][1]($objConverterfields, $objSource, $arrExistentData);
